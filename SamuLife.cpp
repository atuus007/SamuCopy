...
{
  setWindowTitle ( "SamuBrain/SamuCopy, exp. 5: Classes of MPUs / Copy MPU, cognitive mental organs: MPU (Mental Processing Unit), COP-based Q-learning, acquiring higher-order knowledge" );
